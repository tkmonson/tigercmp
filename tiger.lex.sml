...
fun yyAction41 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (Tokens.INT(case Int.fromString(yytext) of SOME y => y | NONE => ~1, yypos,yypos+size(yytext)))
      end
...
fun yyAction44 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; stringStart :=0; stringBuffer := ""; inStringMode := true; stringStart := yypos; continue()))
fun yyAction45 (strm, lastMatch : yymatch) = (yystrm := strm;
      (inStringMode := false; YYBEGIN INITIAL; Tokens.STRING(!stringBuffer,!stringStart,yypos+1)))
fun yyAction46 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (stringBuffer := !stringBuffer ^ yytext; continue())
      end
...
fun yyAction49 (strm, lastMatch : yymatch) = (yystrm := strm;
      (stringBuffer := !stringBuffer ^ "\t"; continue()))
...
fun yyAction52 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (stringBuffer := !stringBuffer ^ str(Char.chr(case Int.fromString(String.extract (yytext,1,NONE)) of SOME y => y | NONE => ~1)); continue())
      end
fun yyAction53 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (stringBuffer := !stringBuffer ^ str(case Char.fromString(yytext) of SOME y => y | NONE => #"a"); continue())
      end
...
fun yyAction55 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos ("Unclosed comment at EOF"); continue()))
...
fun yyAction58 (strm, lastMatch : yymatch) = (yystrm := strm;
      (commentDepth := !commentDepth-1; if !commentDepth=0
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction42(strm, yyNO_MATCH)
                      else yyQ70(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ70(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction2(strm, yyNO_MATCH)
                      else yyQ70(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction2(strm, yyNO_MATCH)
                  else yyQ70(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ70(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction3(strm, yyNO_MATCH)
                      else yyQ70(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction3(strm, yyNO_MATCH)
                  else yyQ70(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ70(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"\^N"
              ...
              then if inp = #"\v"
                  ...
                  then if inp <= #"\b"
                      then yyAction61(strm, yyNO_MATCH)
                      else yyQ91(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
                else if inp = #"\r"
            ...
            if inp = #":"
              ...
              then if inp = #"\^N"
                  ...
                  then if inp = #"\v"
                      ...
                      then if inp <= #"\b"
                          then yyAction42(strm, yyNO_MATCH)
                          else yyQ91(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                    else if inp = #"\r"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction4(strm, yyNO_MATCH)
                      else yyQ70(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction4(strm, yyNO_MATCH)
                  else yyQ70(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ70(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
       ...
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ114(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ70(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
              else yyAction42(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ113(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ70(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
...
fun yyQ51 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction22(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ116(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ117(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
...
fun yyQ120 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction41(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ120(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ45 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction27(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ121(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"\^N"
              ...
              then if inp = #"\v"
                  ...
                  then if inp <= #"\b"
                      then yyAction0(strm, yyNO_MATCH)
                      else yyQ91(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
                else if inp = #"\r"
...
fun yyQ1 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ29(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp < #"*"
              then if inp = #"\n"
                  then yyQ28(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                  else yyQ27(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp = #"/"
              then yyQ30(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
              else yyQ27(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
      (* end case *))
...
fun yyQ18 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\v"
              then yyQ9(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp < #"\v"
              then if inp = #"\n"
                  then yyAction49(strm, yyNO_MATCH)
                  else yyQ9(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp = #"Z"
        ...
        | SOME(inp, strm') =>
            if inp = #"\v"
              ...
              then if inp = #"\n"
                  ...
                  else yyQ9(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp = #"Z"
...
fun yyQ20 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction53(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\v"
              then yyQ9(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
            else if inp < #"\v"
              then if inp = #"\n"
                  then yyAction53(strm, yyNO_MATCH)
                  else yyQ9(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
            else if inp = #"Z"
        ...
        | SOME(inp, strm') =>
            if inp = #"\v"
              ...
              then if inp = #"\n"
                  ...
                  else yyQ9(strm', yyMATCH(strm, yyAction50, yyNO_MATCH))
            else if inp = #"Z"
              then yyQ14(strm', yyMATCH(strm, yyAction50, yyNO_MATCH))
              else yyQ9(strm', yyMATCH(strm, yyAction50, yyNO_MATCH))
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"\v"
              ...
              then if inp = #"\n"
                  ...
                  else yyQ9(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp = #"Z"
        ...
        | SOME(inp, strm') =>
            if inp = #"\v"
              ...
              then if inp = #"\n"
                  ...
                  else yyQ9(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp = #"Z"
...
fun yyQ8 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction62(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"Z"
              then yyQ14(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp < #"Z"
              then if inp = #" "
                  ...
                  then if inp = #"\v"
                      ...
                      then if inp = #"\t"
                          ...
                          then yyQ11(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                  ...
                  then if inp = #"!"
                      then yyQ9(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                      else yyQ12(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                else if inp = #"0"
                  then yyQ13(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                else if inp < #"0"
                  then yyQ9(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                else if inp <= #"9"
                  then yyQ13(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
              ...
              then if inp = #"]"
                  ...
                  then if inp = #"["
                      then yyQ9(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                      else yyQ15(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                else if inp = #"^"
                  then yyQ16(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                  else yyQ9(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp = #"o"
              then yyQ9(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"n"
                  then yyQ17(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                  else yyQ9(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp = #"t"
              then yyQ18(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
              else yyQ9(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
      (* end case *))
            ...
            if inp = #"#"
              ...
              then if inp = #"\v"
                  ...
                  then if inp = #"\n"
                      ...
                      else yyQ9(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp = #" "
                  then yyQ25(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp < #" "
                  then yyQ9(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                  ...
                  then yyQ9(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                  else yyQ25(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp = #"\\"
              then yyQ9(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp < #"\\"
              then if inp = #"Z"
...
fun yyQ6 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\v"
              then yyQ9(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp < #"\v"
              then if inp = #"\n"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ9(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"Z"
              then yyQ14(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyQ9(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
      (* end case *))
       ...
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"#"
              ...
              then if inp = #"\v"
                  then yyQ3(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp < #"\v"
                  then if inp = #"\n"
                      then yyQ4(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                      else yyQ3(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp = #" "
                  then yyQ5(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp < #" "
                  then yyQ3(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                  ...
                  else yyQ5(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp = #"\\"
              then yyQ8(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp < #"\\"
              then if inp = #"Z"
                  then yyQ7(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                  else yyQ5(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp <= #"~"
              then yyQ5(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
              else yyQ3(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
