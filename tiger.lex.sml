       ...
       of NONE => yyAction2(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"_"
                  then yyQ47(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction1(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction1(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction5(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction5(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ47(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction3(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction3(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ47(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction4(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction4(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ85(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ47(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
              else yyAction43(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ89(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ47(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
              else yyAction43(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ26 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ93(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
...
fun yyQ24 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ94(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #" "
              ...
              then if inp = #"\""
                  ...
                  else yyQ98(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp <= #"~"
              then yyQ98(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
              else yyAction42(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ5 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ8(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
...
fun yyQ4 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"+"
              then yyQ4(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp < #"+"
              then if inp = #"*"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ4(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"/"
              then yyAction45(strm, yyNO_MATCH)
              else yyQ4(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
      (* end case *))
...
fun yyQ0 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"\""
              then yyQ3(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp < #"\""
              then if inp = #"\v"
                  then yyQ2(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                else if inp < #"\v"
                  then if inp = #"\t"
                      then yyQ3(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                    else if inp = #"\n"
                      then yyQ4(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                      else yyQ2(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                else if inp = #" "
                  then yyQ3(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                  else yyQ2(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"+"
              ...
              then yyQ6(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyQ2(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
      (* end case *))
in
  (case (!(yyss))
